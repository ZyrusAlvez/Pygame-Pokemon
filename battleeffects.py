...
firefx = BattleEffects("assets/Attack_Impact/Fire.gif", "Fire")
waterfx = BattleEffects("assets/Attack_Impact/Water.gif", "Water")
grassfx = BattleEffects("assets/Attack_Impact/Grass.gif", "Grass")
